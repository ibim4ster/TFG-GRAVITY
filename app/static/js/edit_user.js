document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('editUserForm').addEventListener('submit', function (event) {
        ...
        const userId = this.dataset.userId; // Obtener del dataset del form
    ...
    document.getElementById('deleteUser').addEventListener('click', function () {
        if (confirm("¿Estás seguro de que deseas eliminar este usuario? Esta acción no se puede deshacer.")) {
            const userId = this.dataset.userId; // Obtener el ID del botón
    ...
    document.getElementById('assignLicenseBtn').addEventListener('click', function () {
        ...
        const userId = document.getElementById('editUserForm').dataset.userId; // Obtener del form
    ...
    if (licenseTypeSelect && licenseTypeSelect.value === 'Permanente') {
        const dateField = document.getElementById('license_end');
        if (dateField) {
            dateField.parentElement.style.display = 'none';
        }
